...
export function pluralize(count: number, word: string, options?: { withoutCount?: boolean }): string;

export function pluralize(...args: Parameters<Pluralize> | Parameters<PluralizeWithCount>): string {
  if (args.length === 1) {
